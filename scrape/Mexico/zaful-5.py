...
file = open("/home/aa/cloudJ/JB/PRD/scrapper/Scripts/Mexico/zaful-5.txt", "w")
...
df.to_excel(f'/home/aa/cloudJ/JB/PRD/scrapper/Scripts/Mexico/Salida/zaful-5{fecha}.xlsx')
print('TERMINO ZAFUL-5.py')
